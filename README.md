...
| Day | Project | Skill | Status |
|-----|---------|-------|--------|
| 01 | [Near-Duplicate Finder](./day-01-duplicate-finder) | Vector embeddings · cosine similarity · clustering | ✅ |

*One new row a day.*

## Why I'm doing it this way

A lot of beginner portfolios end up looking the same because they all follow the same tutorials. I wanted something that actually reflects how I learn — building on what I picked up the day before, keeping a steady streak going, and making sure I understand each piece instead of just copying it across. It's as much a learning log as a portfolio, and honestly that's the part I'm enjoying most.
